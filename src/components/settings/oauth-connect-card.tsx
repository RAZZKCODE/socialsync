...
export function OAuthConnectCard({
  ...
  const redirectUri = `${browserOrigin}/api/v1/auth/${platform.id}/callback`;
  ...
  function renderConnectionStatus() {
    if (justConnected || isConnected) {
      return (
        <div className="rounded-lg border border-success/20 bg-success/5 px-4 py-3 flex flex-col gap-3 sm:flex-row sm:items-start">
          ...
          <Button
            ...
            className="shrink-0 self-start text-error hover:text-error sm:self-auto"
          >
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border overflow-hidden">
          <button
            ...
            className="w-full flex items-center justify-between gap-3 px-4 py-3 text-left text-sm font-medium text-foreground hover:bg-surface/50 transition-colors"
          >
            <span className="flex min-w-0 items-center gap-2">
              <Key size={14} strokeWidth={1.8} />
              <span className="truncate">Use your own OAuth app</span>
            ...
            <div className="px-4 pb-4 space-y-4 border-t border-border">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-2">
                  <code className="flex-1 text-xs text-text-muted font-[family-name:var(--font-code)] break-all sm:truncate">
                    {redirectUri}
                  </code>
                  <button
                    type="button"
