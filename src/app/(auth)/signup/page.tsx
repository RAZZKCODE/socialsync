    ...
    return (
      <div className="flex min-h-dvh items-center justify-center bg-background px-4 py-6">
        <div className="w-full max-w-[400px] text-center">
          ...
          <h1 className="text-2xl font-bold tracking-normal font-[family-name:var(--font-heading)] text-foreground mb-2">
            Check your email
          </h1>
      ...
      <div className="w-full max-w-[400px]">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-xs font-semibold text-white hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-50"
          >
